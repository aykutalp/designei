...
if section="list" or section="" then
	...
	'if  cultureRs.Eof or cultureRs.Bof   then '\\\\\\\\\\\\\\\\\\\\\\\\ Kayýt Yoksa Yzýdýrýr.
							...
							Set Filee = Upload.Files("img")
								...
								Set Jpeg = Server.CreateObject("Persits.Jpeg")
									...
									if Jpeg.OriginalWidth <> 237 and Jpeg.OriginalHeight <> 237 then
										...
										del.DeleteFile(""&Request.ServerVariables("APPL_PHYSICAL_PATH" )&"images\culture\"&filename )'Eðer site ana dizinde olucaksa ilk baþtaki cultureei kaldýrýlýcak 
