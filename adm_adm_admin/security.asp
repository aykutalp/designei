...
'data = Replace (data ,"%20","Bu siteye hack etmeye çalýþtým ben bi salaðým",1,-1,1)
data = Replace (data ,"Html","Bu siteye hack etmeye çalýþtým ben bi salaðým",1,-1,1)
data = Replace (data ,"html","Bu siteye hack etmeye çalýþtým ben bi salaðým",1,-1,1)
data = Replace (data ,"Body","Bu siteye hack etmeye çalýþtým ben bi salaðým",1,-1,1)
data = Replace (data ,"body","Bu siteye hack etmeye çalýþtým ben bi salaðým",1,-1,1)
data = Replace (data ,"Body","Bu siteye hack etmeye çalýþtým ben bi salaðým",1,-1,1)
